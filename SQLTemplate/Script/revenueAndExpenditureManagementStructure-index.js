...
$(function () {
    ...
    window.operateFormatter = function (value, row, index) {
        return [
            '<a href="#" class="u-edit"',
                ' data-u-url="/Admin/Manager/RevenueAndExpenditureManagementStructure/Edit/' + value + '"',
            '>',
                '编辑',
                '<i class="fa fa-pencil" aria-hidden="true"></i>',
            '</a>',
            '<a href="#" class="u-delete"',
                ' data-u-url="/Admin/Manager/RevenueAndExpenditureManagementStructure/Remove/' + value + '"',
            '>',
                '删除',
